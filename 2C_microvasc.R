...
labeltext <- cbind(c("Sensitivity",
                   ...
                   # the data ------------
                   c("Both sexes [95% CI]",
                    get_stat(t_mvd_echo, "se"),
                    get_stat(t_mvd_ecg, "se"),
                    get_stat(t_mvd_comp, "se"),

                    "",
                    get_stat(t_mvd_echo, "sp"),
                    get_stat(t_mvd_ecg, "sp"),
                    get_stat(t_mvd_comp, "sp"),

                    "",
                    get_stat(t_mvd_echo, "ppv"),
                    get_stat(t_mvd_ecg, "ppv"),
                    get_stat(t_mvd_comp, "ppv"),

                    "",
                    get_stat(t_mvd_echo, "npv"),
                    get_stat(t_mvd_ecg, "npv"),
                    get_stat(t_mvd_comp, "npv")
                     ))

mean_points_m <-  c(NA,
        get_est(tm_mvd_echo, stat="se", est =1),
        get_est(tm_mvd_ecg, stat="se", est =1),
        get_est(tm_mvd_comp, stat="se", est =1),

        NA,
        get_est(tm_mvd_echo, stat="sp", est =1),
        get_est(tm_mvd_ecg, stat="sp", est =1),
        get_est(tm_mvd_comp, stat="sp", est =1),

        NA,
        get_est(tm_mvd_echo, stat="ppv", est =1),
        get_est(tm_mvd_ecg, stat="ppv", est =1),
        get_est(tm_mvd_comp, stat="ppv", est =1),

        NA,
        get_est(tm_mvd_echo, stat="npv", est =1),
        get_est(tm_mvd_ecg, stat="npv", est =1),
        get_est(tm_mvd_comp, stat="npv", est =1)
       )

mean_points_f <-  c(NA,
       get_est(tf_mvd_echo, stat="se", est =1),
       get_est(tf_mvd_ecg, stat="se", est =1),
       get_est(tf_mvd_comp, stat="se", est =1),

       NA,
       get_est(tf_mvd_echo, stat="sp", est =1),
       get_est(tf_mvd_ecg, stat="sp", est =1),
       get_est(tf_mvd_comp, stat="sp", est =1),

       NA,
       get_est(tf_mvd_echo, stat="ppv", est =1),
       get_est(tf_mvd_ecg, stat="ppv", est =1),
       get_est(tf_mvd_comp, stat="ppv", est =1),

       NA,
       get_est(tf_mvd_echo, stat="npv", est =1),
       get_est(tf_mvd_ecg, stat="npv", est =1),
       get_est(tf_mvd_comp, stat="npv", est =1)
      )
...
lower_points_m <-  c(NA,
       get_est(tm_mvd_echo, stat="se", est =2),
       get_est(tm_mvd_ecg, stat="se", est =2),
       get_est(tm_mvd_comp, stat="se", est =2),

       NA,
       get_est(tm_mvd_echo, stat="sp", est =2),
       get_est(tm_mvd_ecg, stat="sp", est =2),
       get_est(tm_mvd_comp, stat="sp", est =2),

       NA,
       get_est(tm_mvd_echo, stat="ppv", est =2),
       get_est(tm_mvd_ecg, stat="ppv", est =2),
       get_est(tm_mvd_comp, stat="ppv", est =2),

       NA,
       get_est(tm_mvd_echo, stat="npv", est =2),
       get_est(tm_mvd_ecg, stat="npv", est =2),
       get_est(tm_mvd_comp, stat="npv", est =2)
      )

lower_points_f <-  c(NA,
     get_est(tf_mvd_echo, stat="se", est =2),
     get_est(tf_mvd_ecg, stat="se", est =2),
     get_est(tf_mvd_comp, stat="se", est =2),

     NA,
     get_est(tf_mvd_echo, stat="sp", est =2),
     get_est(tf_mvd_ecg, stat="sp", est =2),
     get_est(tf_mvd_comp, stat="sp", est =2),

     NA,
     get_est(tf_mvd_echo, stat="ppv", est =2),
     get_est(tf_mvd_ecg, stat="ppv", est =2),
     get_est(tf_mvd_comp, stat="ppv", est =2),

     NA,
     get_est(tf_mvd_echo, stat="npv", est =2),
     get_est(tf_mvd_ecg, stat="npv", est =2),
     get_est(tf_mvd_comp, stat="npv", est =2)
    )



upper_points_m <-  c(NA,
      get_est(tm_mvd_echo, stat="se", est =3),
      get_est(tm_mvd_ecg, stat="se", est =3),
      get_est(tm_mvd_comp, stat="se", est =3),

      NA,
      get_est(tm_mvd_echo, stat="sp", est =3),
      get_est(tm_mvd_ecg, stat="sp", est =3),
      get_est(tm_mvd_comp, stat="sp", est =3),

      NA,
      get_est(tm_mvd_echo, stat="ppv", est =3),
      get_est(tm_mvd_ecg, stat="ppv", est =3),
      get_est(tm_mvd_comp, stat="ppv", est =3),

      NA,
      get_est(tm_mvd_echo, stat="npv", est =3),
      get_est(tm_mvd_ecg, stat="npv", est =3),
      get_est(tm_mvd_comp, stat="npv", est =3)
     )

 upper_points_f <-  c(NA,
       get_est(tf_mvd_echo, stat="se", est =3),
       get_est(tf_mvd_ecg, stat="se", est =3),
       get_est(tf_mvd_comp, stat="se", est =3),

       NA,
       get_est(tf_mvd_echo, stat="sp", est =3),
       get_est(tf_mvd_ecg, stat="sp", est =3),
       get_est(tf_mvd_comp, stat="sp", est =3),

       NA,
       get_est(tf_mvd_echo, stat="ppv", est =3),
       get_est(tf_mvd_ecg, stat="ppv", est =3),
       get_est(tf_mvd_comp, stat="ppv", est =3),

       NA,
       get_est(tf_mvd_echo, stat="npv", est =3),
       get_est(tf_mvd_ecg, stat="npv", est =3),
       get_est(tf_mvd_comp, stat="npv", est =3)
      )
                   # the labels -----------
labeltext <- cbind(c("Sensitivity",
                     "Stress echo",
...
# ------------------------------------------------------------------------------
pdf("figs/fig2C_microvasc_color.pdf")
...
pdf("figs/fig2C_microvasc_bw.pdf")
