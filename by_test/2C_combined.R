...
# ------------------------------------------------------------------------------
pdf("by_test/figs/fig2C_comp_color.pdf")
    ...
    forestplot(labeltext = labeltext,
        ...
        is.summary = c(TRUE, rep(FALSE,4),TRUE, rep(FALSE,4),TRUE, rep(FALSE,4),TRUE, rep(FALSE,4)),
        graph.pos="right",
        xlab = "Proportion",
...
pdf("by_test/figs/fig2C_comp_bw.pdf")
