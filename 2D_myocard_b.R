...
labeltext <- cbind(c("Sensitivity",
                   ...
                   c("Both sexes [95% CI]",
                    get_stat(t_mb_echo, "se"),
                    get_stat(t_mb_ecg, "se"),
                    get_stat(t_mb_comp, "se"),

                    "",
                    get_stat(t_mb_echo, "sp"),
                    get_stat(t_mb_ecg, "sp"),
                    get_stat(t_mb_comp, "sp"),

                    "",
                    get_stat(t_mb_echo, "ppv"),
                    get_stat(t_mb_ecg, "ppv"),
                    get_stat(t_mb_comp, "ppv"),

                    "",
                    get_stat(t_mb_echo, "npv"),
                    get_stat(t_mb_ecg, "npv"),
                    get_stat(t_mb_comp, "npv")
                     ))

mean_points_m <-  c(NA,
        get_est(tm_mb_echo, stat="se", est =1),
        get_est(tm_mb_ecg, stat="se", est =1),
        get_est(tm_mb_comp, stat="se", est =1),

        NA,
        get_est(tm_mb_echo, stat="sp", est =1),
        get_est(tm_mb_ecg, stat="sp", est =1),
        get_est(tm_mb_comp, stat="sp", est =1),

        NA,
        get_est(tm_mb_echo, stat="ppv", est =1),
        get_est(tm_mb_ecg, stat="ppv", est =1),
        get_est(tm_mb_comp, stat="ppv", est =1),

        NA,
        get_est(tm_mb_echo, stat="npv", est =1),
        get_est(tm_mb_ecg, stat="npv", est =1),
        get_est(tm_mb_comp, stat="npv", est =1)
       )

mean_points_f <-  c(NA,
       get_est(tf_mb_echo, stat="se", est =1),
       get_est(tf_mb_ecg, stat="se", est =1),
       get_est(tf_mb_comp, stat="se", est =1),

       NA,
       get_est(tf_mb_echo, stat="sp", est =1),
       get_est(tf_mb_ecg, stat="sp", est =1),
       get_est(tf_mb_comp, stat="sp", est =1),

       NA,
       get_est(tf_mb_echo, stat="ppv", est =1),
       get_est(tf_mb_ecg, stat="ppv", est =1),
       get_est(tf_mb_comp, stat="ppv", est =1),

       NA,
       get_est(tf_mb_echo, stat="npv", est =1),
       get_est(tf_mb_ecg, stat="npv", est =1),
       get_est(tf_mb_comp, stat="npv", est =1)
      )
...
lower_points_m <-  c(NA,
       get_est(tm_mb_echo, stat="se", est =2),
       get_est(tm_mb_ecg, stat="se", est =2),
       get_est(tm_mb_comp, stat="se", est =2),

       NA,
       get_est(tm_mb_echo, stat="sp", est =2),
       get_est(tm_mb_ecg, stat="sp", est =2),
       get_est(tm_mb_comp, stat="sp", est =2),

       NA,
       get_est(tm_mb_echo, stat="ppv", est =2),
       get_est(tm_mb_ecg, stat="ppv", est =2),
       get_est(tm_mb_comp, stat="ppv", est =2),

       NA,
       get_est(tm_mb_echo, stat="npv", est =2),
       get_est(tm_mb_ecg, stat="npv", est =2),
       get_est(tm_mb_comp, stat="npv", est =2)
      )

lower_points_f <-  c(NA,
     get_est(tf_mb_echo, stat="se", est =2),
     get_est(tf_mb_ecg, stat="se", est =2),
     get_est(tf_mb_comp, stat="se", est =2),

     NA,
     get_est(tf_mb_echo, stat="sp", est =2),
     get_est(tf_mb_ecg, stat="sp", est =2),
     get_est(tf_mb_comp, stat="sp", est =2),

     NA,
     get_est(tf_mb_echo, stat="ppv", est =2),
     get_est(tf_mb_ecg, stat="ppv", est =2),
     get_est(tf_mb_comp, stat="ppv", est =2),

     NA,
     get_est(tf_mb_echo, stat="npv", est =2),
     get_est(tf_mb_ecg, stat="npv", est =2),
     get_est(tf_mb_comp, stat="npv", est =2)
    )



upper_points_m <-  c(NA,
      get_est(tm_mb_echo, stat="se", est =3),
      get_est(tm_mb_ecg, stat="se", est =3),
      get_est(tm_mb_comp, stat="se", est =3),

      NA,
      get_est(tm_mb_echo, stat="sp", est =3),
      get_est(tm_mb_ecg, stat="sp", est =3),
      get_est(tm_mb_comp, stat="sp", est =3),

      NA,
      get_est(tm_mb_echo, stat="ppv", est =3),
      get_est(tm_mb_ecg, stat="ppv", est =3),
      get_est(tm_mb_comp, stat="ppv", est =3),

      NA,
      get_est(tm_mb_echo, stat="npv", est =3),
      get_est(tm_mb_ecg, stat="npv", est =3),
      get_est(tm_mb_comp, stat="npv", est =3)
     )

 upper_points_f <-  c(NA,
       get_est(tf_mb_echo, stat="se", est =3),
       get_est(tf_mb_ecg, stat="se", est =3),
       get_est(tf_mb_comp, stat="se", est =3),

       NA,
       get_est(tf_mb_echo, stat="sp", est =3),
       get_est(tf_mb_ecg, stat="sp", est =3),
       get_est(tf_mb_comp, stat="sp", est =3),

       NA,
       get_est(tf_mb_echo, stat="ppv", est =3),
       get_est(tf_mb_ecg, stat="ppv", est =3),
       get_est(tf_mb_comp, stat="ppv", est =3),

       NA,
       get_est(tf_mb_echo, stat="npv", est =3),
       get_est(tf_mb_ecg, stat="npv", est =3),
       get_est(tf_mb_comp, stat="npv", est =3)
      )
                   # the labels -----------
labeltext <- cbind(c("Sensitivity",
                     "Stress echo",
...
# ------------------------------------------------------------------------------
pdf("figs/fig2D_myocard_bridge_color.pdf")
...
pdf("figs/fig2D_myocard_bridge_bw.pdf")
